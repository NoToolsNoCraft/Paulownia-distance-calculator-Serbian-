function initMap() {
    ...
    google.maps.event.addListener(drawingManager, 'overlaycomplete', function (event) {
        ...
        if (exclusionMode) {
            ...
            const landLabel = `Površina ${areas.length + 1}`;
    ...
    document.getElementById('toggle-exclusion').addEventListener('click', function () {
        ...
        if (exclusionMode) {
            this.innerText = 'Obeleži željeno zemljište';
            ...
            this.innerText = 'Prebaci se u režim isključivanja';
...
`;
        ...
        output += `<div class="land-box"><div class="land-header">Ukupna površina: ${(totalArea / 10000).toFixed(2)} ha (${totalArea.toFixed(2)} m²)</div></div>`;
